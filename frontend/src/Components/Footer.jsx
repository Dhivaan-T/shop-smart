    ...
    return(
        <div className="footerPage">
            <div className="footer-box1">
                ...
                <div className="top-box">
                    <ul>
                        ...
                        <li>Sell on Shop Smart</li>
                        <li>Advertise Your Products</li>
                        <li>Supply to Shop Smart</li>
                    </ul>
                </div>
            ...
            <div className="footer-box2">
                ...
                <div className="box-2">
                    <p>At Shop Smart, we are committed to protecting your privacy. this Privacy Policy explains how we collect, use and safeguard your info. when you visit our website.</p>
                </div>
                <div className="box-3">
